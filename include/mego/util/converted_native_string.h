...
inline void mgu__free_converted_native_string(const char *_src, mmn_char_cptr_t _new)
{
    (void*)_src;
...
inline mgec_t mgu_w__to_converted_native_string(
    const wchar_t *_src, size_t _slen, 
    mmn_char_cptr_t *_out, size_t *_out_slen, int _must_alloc)
{
    wchar_t * path = NULL;
...
inline void mgu_w__free_converted_native_string(const wchar_t *_src, mmn_char_cptr_t _new)
{
