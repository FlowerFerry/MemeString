...
namespace memepp {
	...
	MEMEPP__IMPL_INLINE variable_buffer& variable_buffer::append(const_pointer _buf, size_type _len) MEGOPP__NOEXCEPT
	{
		MemeVariableBuffer_appendWithBytes(to_pointer(data_), _buf, _len);
		return *this;
	}

	MEMEPP__IMPL_INLINE variable_buffer& variable_buffer::append(const variable_buffer& _other) MEGOPP__NOEXCEPT
	{
		MemeVariableBuffer_appendWithOther(to_pointer(data_), to_pointer(_other.data_));
		return *this;
	}

	MEMEPP__IMPL_INLINE variable_buffer& variable_buffer::append(variable_buffer&& _other) MEGOPP__NOEXCEPT
	{
		MemeVariableBuffer_appendWithOther(to_pointer(data_), to_pointer(_other.data_));
		return *this;
	}

	MEMEPP__IMPL_INLINE variable_buffer& variable_buffer::append(const string& _other) MEGOPP__NOEXCEPT
	{
	...
	MEMEPP__IMPL_INLINE variable_buffer& variable_buffer::append(const string_view& _other) MEGOPP__NOEXCEPT
	{
		MemeVariableBuffer_appendWithBytes(to_pointer(data_),
			reinterpret_cast<const MemeByte_t*>(_other.data()), _other.size());
		return *this;
	...
	MEMEPP__IMPL_INLINE variable_buffer& variable_buffer::resize(size_type _count) MEGOPP__NOEXCEPT
	{
	...
	MEMEPP__IMPL_INLINE variable_buffer& variable_buffer::resize(size_type _count, value_type _value) MEGOPP__NOEXCEPT
	{
