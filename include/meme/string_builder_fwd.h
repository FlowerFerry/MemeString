...
typedef struct _MemeStringBuilder_t* mmsbuilder_t;
typedef const struct _MemeStringBuilder_t* mmsbuilder_const_t;
...
typedef MemeStringBuilderStack_t mmsbuilder_stack_t;
