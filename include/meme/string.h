...
MEME_STDCALL MemeStringStack_fromInt16(
    int16_t _value, int _radix, mmstrstk_t* _out, mmint_t _obj_size);

MEME_API mgec_t
MEME_STDCALL MemeStringStack_fromInt32(
    int32_t _value, int _radix, mmstrstk_t* _out, mmint_t _obj_size);

MEME_API mgec_t
MEME_STDCALL MemeStringStack_fromInt64(
    int64_t _value, int _radix, mmstrstk_t* _out, mmint_t _obj_size);
//
