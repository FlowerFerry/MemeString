...
namespace megopp {
	...
	struct bit_field_member : bit_field_member_private<_BeginBit, _BitSize, _Type, _Endian>
    {

        inline constexpr explicit operator _Type() const noexcept
        {
            return (_Type)((data_ >> begin_bit_index) & mask);
        }
        ...
        {
            return get_value() == static_cast<uint_type>(_value);
        }
        ...
        {
            return static_cast<_Ty>(get_value());
        }

        inline constexpr bit_field_member& operator=(const _Type& _value) noexcept
        {
            set_value(static_cast<uint_type>(_value));
            return *this;
        }
    ...
    struct bit_field_member_private<_BeginBit, _BitSize, _Type, endian_t::native>
    {
        using uint_type = typename types_by_size<sizeof(_Type)>::uint;
