...
TEST_CASE("memepp::string utf8", "[string]")
{
	...
	auto c8_01_03 = "\xE7\x9A\x84\xE4\xB8\x80\xE4\xB8\x8D\xE6\x98\xAFh\xE4\xBA\xBA\xE5\x9C\xA8\xE6\x9C\x89\xE6\x88\x91\xE4\xBB\x96\xE8\xBF\x99\xE4\xB8\xBA\xE4\xB9\x8B\xE6\x9D\xA5\xE5\xA4\xA7\xE4\xBB\xA5\xE4\xB8\xAA\xE4\xB8\xAD\xE4\xB8\x8A\xE4\xBB\xAC";
	memepp::string s01_01{ c8_01_01 };
    ...
    auto s01_05 = s01_01.mapping_convert([](memepp::rune& r)
    {
        if (r == "\xE4\xBA\x86")
            r = memepp::rune{ (const uint8_t*)"\xE4\xB8\x8D", -1 };
        return 0;
    });
    REQUIRE(s01_05.size() == strlen(c8_01_02));
    REQUIRE(s01_05 == c8_01_02);

    auto s01_06 = s01_01.mapping_convert([](memepp::rune& r)
    {
        if (r == "\xE4\xBA\x86")
            r = memepp::rune{ 'h' };
        return 0;
    });
    REQUIRE(s01_06.size() == strlen(c8_01_03));
    REQUIRE(s01_06 == c8_01_03);
...
TEST_CASE("memepp::string import from dll and export into dll", "[string]")
{
	...
	auto str02_01 = mm_from(std::string{ 
...
TEST_CASE("memepp::string format", "[string]")
{
    ...
    auto str01_02 = memepp::c_format(-1, 7, "Hello %s", "World");
    REQUIRE(str01_02 == "Hello World");
	
    auto str01_03 = memepp::c_format(7, -1, "Hello %s", "World");
    REQUIRE(str01_03 == "Hello W");

    auto str01_04 = memepp::c_format(7, 5, "Hello %s", "World");
    REQUIRE(str01_04 == "Hello W");
	
    auto str01_05 = memepp::c_format(5, 7, "Hello %s", "World");
    REQUIRE(str01_05 == "Hello");
