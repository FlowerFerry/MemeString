...
MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBufferStack_initByString(
...
MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBufferStack_regSize(const mmbufstk_t* _obj)
{
	return MemeStringStack_regSize((const mmstrstk_t*)_obj);
}

MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBufferStack_objSize(const mmbufstk_t* _obj)
{
...
MEME_EXTERN_C MEME_API MemeBuffer_Storage_t
...
MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBuffer_isEmpty(MemeBuffer_Const_t _s)
{
	return MemeString_isEmpty((MemeString_Const_t)_s);
}

MEME_EXTERN_C MEME_API const mmbyte_t*
...
MEME_EXTERN_C MEME_API mmint_t MEME_STDCALL MemeBuffer_isSharedStorageTypes(mmbuf_const_t _b)
{
...
MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBufferViewUnsafeStack_initByString(
...
MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBufferViewUnsafeStack_initByVariableBuffer(
...
MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBufferViewUnsafeStack_assignByString(
	mmbufstk_t* _self, size_t _object_size, const mmsstk_t* _other)
{
    return MemeBufferViewUnsafeStack_assignByOther(_self, _object_size, (mmbufstk_t*)_other);
}

MEME_EXTERN_C MEME_API int MEME_STDCALL MemeBufferViewUnsafeStack_assignByVariableBuffer(
	mmbufstk_t* _self, size_t _object_size, const mmvbstk_t* _other)
{
	mmsstk_t* s = (mmsstk_t*)_self;
