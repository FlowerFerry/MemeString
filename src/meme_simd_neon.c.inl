...
void mmsimd_neon_i8_div(const int8_t* _a, const int8_t* _b, int8_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    for (; i + (mmint_t)sizeof(int8x16_t) <= _n; i += (mmint_t)sizeof(int8x16_t))
    {
...
void mmsimd_neon_i8_div_scalar(const int8_t* _a, int8_t _b, int8_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    int8x16_t vb = vdupq_n_s8(_b);
    for (; i + (mmint_t)sizeof(int8x16_t) <= _n; i += (mmint_t)sizeof(int8x16_t))
...
void mmsimd_neon_u8_div(const uint8_t* _a, const uint8_t* _b, uint8_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    for (; i + (mmint_t)sizeof(uint8x16_t) <= _n; i += (mmint_t)sizeof(uint8x16_t))
    {
...
void mmsimd_neon_u8_div_scalar(const uint8_t* _a, uint8_t _b, uint8_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    uint8x16_t vb = vdupq_n_u8(_b);
    for (; i + (mmint_t)sizeof(uint8x16_t) <= _n; i += (mmint_t)sizeof(uint8x16_t))
...
void mmsimd_neon_i16_div(const int16_t* _a, const int16_t* _b, int16_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    for (; i + (mmint_t)sizeof(int16x8_t) <= _n; i += (mmint_t)sizeof(int16x8_t))
    {
...
void mmsimd_neon_i16_div_scalar(const int16_t* _a, int16_t _b, int16_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    int16x8_t vb = vdupq_n_s16(_b);
    for (; i + (mmint_t)sizeof(int16x8_t) <= _n; i += (mmint_t)sizeof(int16x8_t))
...
void mmsimd_neon_u16_div(const uint16_t* _a, const uint16_t* _b, uint16_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    for (; i + (mmint_t)sizeof(uint16x8_t) <= _n; i += (mmint_t)sizeof(uint16x8_t))
    {
...
void mmsimd_neon_u16_div_scalar(const uint16_t* _a, uint16_t _b, uint16_t* _c, mmint_t _n)
{
    mmint_t i = 0;
    uint16x8_t vb = vdupq_n_u16(_b);
    for (; i + (mmint_t)sizeof(uint16x8_t) <= _n; i += (mmint_t)sizeof(uint16x8_t))
